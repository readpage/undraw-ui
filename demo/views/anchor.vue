<template>
  <div class="view" style="height: 500px">
      ...
      <div id="article" class="article">
        <section>
          ...
          <div class="content">
            ...
            <p>这是许多人都有的经历，成长，始于告别。这位朋友一直记得笔友所在的城市——就是在饭局上初见的那个人的故乡。朋友随意问起，是否认识某某某(他笔友的名字)。那人当即回道：“我们是邻居。”</p>
            <p>
            ...
            <p>据这家网站统计，已经有80多万名会员收到来自207个国家的6293万张明信片。这种跨越千万里的期待，总是令人怦然心动。</p>
            <h3>中间</h3>
            <p>
            ...
            <p>如今，邮筒正在慢慢消失，说起来总令人深感惋惜。可是，如果让我们回到那个车马慢的时代，估计大部分人会拒绝。</p>
            <p>在这个时代，人们不断往前跑，总会甩下一些东西，有得有失。</p>
            <p>前两天看新闻，一家外卖平台要增加社交功能了。我于是掰着手指头数了数，我们有了电商社交、短视频社交，现在又有外卖社交——真是一个社交途径极丰富的时代。</p>
            <h3>结尾</h3>
            <p>只是，曾经那种社交的丰富感——期待、温馨、畅快、痛苦……已很难感受到了。一个点赞图标，几乎表达了我们作为人类的一切感情。</p>
    ...
    <div class="article-catalog">
      <u-anchor style="position: fixed" container="#article" :target-offset="50" scroll=".anchor .el-scrollbar__wrap"></u-anchor>
    </div>
  </div>
</template>
