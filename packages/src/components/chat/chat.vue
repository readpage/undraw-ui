<template>
  <div class="u-chat">
    <div :class="{ active: active }" class="chat-container translate">
      ...
      <!-- 对话内容 -->
      <Message ref="messageRef" :data="data" :user-id="userId" />
      <!-- 输入框 -->
...
import { UIcon, UEmoji } from 'undraw-ui'
import { ElButton, ElInput } from 'element-plus'
import { ChatApi, ChatSubmitParam, EmojiApi, InjectionEmojiApi, UToast } from '~/components'
...
const emit = defineEmits<{
  (e: 'submit', obj: ChatSubmitParam): void
}>()
...
const submit = () => {
  ...
  if (!t.trim()) {
    ...
    t = t.replace(/\n/g, '<br/>')
    emit('submit', { clear: clear, content: t })
  }
}
