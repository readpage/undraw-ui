<template>
  <div class="u-chat">
    <div :class="{ active: active }" class="chat-container translate">
      ...
      <div class="header">
        <u-icon size="32">
          <svg viewBox="0 0 1318 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      <div id="chat-footer" class="footer">
        <!-- 文字输入 -->
        <el-input id="emojiInput" v-model="content" type="textarea" :autosize="{ minRows: 1, maxRows: 4 }" placeholder="请输入内容" @keydown.enter="keydown"></el-input>
        <!-- 表情框 -->
        ...
        <!-- 发送按钮 -->
        <u-icon size="18" :class="{ 'submit-btn': content.trim() != '' }" class="select-none cursor-pointer" style="padding-bottom: 5px" @click="submit">
